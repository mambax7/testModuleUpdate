...
$templateMain = 'testmoduleupdate_admin_broken.tpl';
...
$GLOBALS['xoopsTpl']->assign('articles_result', \sprintf(\_AM_TESTMODULEUPDATE_BROKEN_RESULT, 'Articles'));
...
if ($articlesCount > 0) {
    ...
    $GLOBALS['xoopsTpl']->assign('nodataArticles', \sprintf(\_AM_TESTMODULEUPDATE_BROKEN_NODATA, 'Articles'));
}
unset($crArticles);
...
$GLOBALS['xoopsTpl']->assign('testfields_result', \sprintf(\_AM_TESTMODULEUPDATE_BROKEN_RESULT, 'Testfields'));
...
if ($testfieldsCount > 0) {
    ...
    $GLOBALS['xoopsTpl']->assign('nodataTestfields', \sprintf(\_AM_TESTMODULEUPDATE_BROKEN_NODATA, 'Testfields'));
}
unset($crTestfields);
