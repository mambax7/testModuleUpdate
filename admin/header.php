...
$modPathIcon16   = \TESTMODULEUPDATE_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons16') . '/';
$modPathIcon32   = \TESTMODULEUPDATE_URL . '/' . $GLOBALS['xoopsModule']->getInfo('modicons32') . '/';
...
$style = \TESTMODULEUPDATE_URL . '/assets/css/admin/style.css';
