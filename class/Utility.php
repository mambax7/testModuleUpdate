...
/**
 * Module:  testmoduleupdate
 *
 * @package      \module\testmoduleupdate\class
...
class Utility
{
    ...
    {
        /** @var Testmoduleupdate\Helper $helper */
        if (null === $options) {
            $options           = [];
            $options['name']   = 'Editor';
