...
$GLOBALS['xoopsOption']['template_main'] = 'testmoduleupdate_index.tpl';
...
$keywords = [];
// Breadcrumbs
$xoBreadcrumbs[] = ['title' => \_MA_TESTMODULEUPDATE_INDEX];
// Paths
...
if ($articlesCount > 0) {
    ...
    $GLOBALS['xoopsTpl']->assign('lang_thereare', \sprintf(\_MA_TESTMODULEUPDATE_INDEX_THEREARE, $articlesCount));
...
if ($testfieldsCount > 0) {
    ...
    $GLOBALS['xoopsTpl']->assign('lang_thereare', \sprintf(\_MA_TESTMODULEUPDATE_INDEX_THEREARE, $testfieldsCount));
    $GLOBALS['xoopsTpl']->assign('divideby', $helper->getConfig('divideby'));
    $GLOBALS['xoopsTpl']->assign('numb_col', $helper->getConfig('numb_col'));
}
unset($count);
...
unset($keywords);
// Description
testmoduleupdateMetaDescription(\_MA_TESTMODULEUPDATE_INDEX_DESC);
$GLOBALS['xoopsTpl']->assign('xoops_mpageurl', \TESTMODULEUPDATE_URL.'/index.php');
$GLOBALS['xoopsTpl']->assign('xoops_icons32_url', \XOOPS_ICONS32_URL);
