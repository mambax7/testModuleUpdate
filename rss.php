...
$categories = testmoduleupdateMyGetItemIds('testmoduleupdate_view', 'testmoduleupdate');
...
if (!$tpl->is_cached('db:testmoduleupdate_rss.tpl', $cid)) {
    ...
    foreach (\array_keys($testfieldsArr) as $i) {
        ...
        $tpl->append('items', ['title' => \htmlspecialchars($testfieldsArr[$i]->getVar('tf_reads'), ENT_QUOTES),
                                    'link' => \XOOPS_URL . '/modules/testmoduleupdate/single.php?cid=' . $testfieldsArr[$i]->getVar('cid') . '&amp;tf_id=' . $testfieldsArr[$i]->getVar('tf_id'),
                                    'guid' => \XOOPS_URL . '/modules/testmoduleupdate/single.php?cid=' . $testfieldsArr[$i]->getVar('cid') . '&amp;tf_id=' . $testfieldsArr[$i]->getVar('tf_id'),
...
$tpl->display('db:testmoduleupdate_rss.tpl', $cid);
